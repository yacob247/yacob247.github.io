const GAMES = [
 ...
 const TOOLS = [
{
    id:"jwt-debugger", type:"tool", title:"Multiple Images Background Remover", grade:"",
    category:"Utilities", tagline:"Remove all backgrounds locally with the range you desire, all for free and no sign up",
    review:[
      "100% free local multiple images background remover."
    ],
    features:["Can adjust the amount of background desired to remove as well as select the colour of the new background or even add images or even videos in the background"],
    mobile: "https://multipleimagesbackgroundremover.envizion.work/",
    launch: true
  }
];

// Load admin-added entries from localStorage
