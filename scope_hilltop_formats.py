...
<aside aria-label="Sponsored advertisement" class="envizion-hilltopads-static-banner" style="max-width:728px;margin:24px auto 0;padding:0;text-align:center;clear:both;">
  <a href="https://plump-plastic.com/AUu7Y4" target="_blank" rel="sponsored noopener" referrerpolicy="no-referrer-when-downgrade">
    <img src="https://static.hilltopads.com/other/banners/pub/huge_income/728x90.gif?v=1787300403" alt="Sponsored advertisement" width="728" height="90" loading="lazy" decoding="async" style="display:block;max-width:100%;height:auto;margin:0 auto;border:0;">
  </a>
</aside>'''
...
<section class="envizion-hilltop-formats" aria-label="Sponsored content" style="max-width:960px;margin:20px auto;padding:10px;text-align:center;clear:both;">
  ...
  <div class="envizion-hilltop-additional-1" data-format="additional" aria-hidden="true">
    <script>
    (function(cfvbq){{
      var d = document, s = d.createElement('script'), l = d.scripts[d.scripts.length - 1];
      s.settings = cfvbq || {{}};
  ...
  <div class="envizion-hilltop-additional-2" data-format="additional" aria-hidden="true">
    <script>
    (function(hfzm){{
      var d = document, s = d.createElement('script'), l = d.scripts[d.scripts.length - 1];
      s.settings = hfzm || {{}};
  ...
  <div class="envizion-hilltop-additional-3" data-format="additional" aria-hidden="true">
    <script>
    (function(hfzm){{
      var d = document, s = d.createElement('script'), l = d.scripts[d.scripts.length - 1];
      s.settings = hfzm || {{}};
  ...
  <div class="envizion-hilltop-additional-5" data-format="additional" aria-hidden="true">
    <script>
    (function(hfzm){{
      var d = document, s = d.createElement('script'), l = d.scripts[d.scripts.length - 1];
      s.settings = hfzm || {{}};
  ...
  <div class="envizion-hilltop-additional-4" data-format="additional" aria-hidden="true">
    <script>
    (function(hfzm){{
      var d = document, s = d.createElement('script'), l = d.scripts[d.scripts.length - 1];
      s.settings = hfzm || {{}};
  ...
  <a class="envizion-hilltop-smartlink" href="{SMARTLINK}" target="_blank" rel="sponsored noopener" referrerpolicy="no-referrer-when-downgrade" style="display:inline-block;margin:12px auto 0;padding:9px 14px;border-radius:8px;background:#2563eb;color:#fff;font-weight:700;text-decoration:none;">Sponsored link</a>
</section>
...
def insert_formats(html: str) -> str:
    ...
    footer = re.search(r"</\s*footer\s*>", html, flags=re.IGNORECASE)
    ...
    if footer and (not main or footer.start() > main.end()):
        return html[:footer.end()] + "\n" + full_bundle + html[footer.end():]
    if main:
